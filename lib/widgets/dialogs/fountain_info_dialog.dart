...
class FountainInfoDialog extends StatefulWidget {
  final Field field;

  const FountainInfoDialog(
    this.field, {
    Key key,
  }) : super(key: key);

  @override
  _FountainInfoDialogState createState() => _FountainInfoDialogState();
}

class _FountainInfoDialogState extends State<FountainInfoDialog> {
